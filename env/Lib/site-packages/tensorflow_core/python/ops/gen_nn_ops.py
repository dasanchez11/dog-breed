  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "AvgPool", name,
        tld.op_callbacks, value, "ksize", ksize, "strides", strides,
...
def avg_pool3d(input, ksize, strides, padding, data_format="NDHWC", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "AvgPool3D", name,
        tld.op_callbacks, input, "ksize", ksize, "strides", strides,
        "padding", padding, "data_format", data_format)
      return _result
    except _core._FallbackException:
      try:
...
def avg_pool3d_grad(orig_input_shape, grad, ksize, strides, padding, data_format="NDHWC", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "AvgPool3DGrad", name,
        tld.op_callbacks, orig_input_shape, grad, "ksize", ksize, "strides",
...
def avg_pool_grad(orig_input_shape, grad, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "AvgPoolGrad", name,
        tld.op_callbacks, orig_input_shape, grad, "ksize", ksize, "strides",
        strides, "padding", padding, "data_format", data_format)
      return _result
    except _core._FallbackException:
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "BatchNormWithGlobalNormalization", name, tld.op_callbacks, t, m, v,
        beta, gamma, "variance_epsilon", variance_epsilon,
...
def _batch_norm_with_global_normalization_eager_fallback(t, m, v, beta, gamma, variance_epsilon, scale_after_normalization, name, ctx):
  variance_epsilon = _execute.make_float(variance_epsilon, "variance_epsilon")
  scale_after_normalization = _execute.make_bool(scale_after_normalization, "scale_after_normalization")
  _attr_T, _inputs_T = _execute.args_to_matching_eager([t, m, v, beta, gamma], ctx)
...
def batch_norm_with_global_normalization_grad(t, m, v, gamma, backprop, variance_epsilon, scale_after_normalization, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "BatchNormWithGlobalNormalizationGrad", name, tld.op_callbacks, t, m,
        v, gamma, backprop, "variance_epsilon", variance_epsilon,
        "scale_after_normalization", scale_after_normalization)
...
def batch_norm_with_global_normalization_grad_eager_fallback(t, m, v, gamma, backprop, variance_epsilon, scale_after_normalization, name, ctx):
  variance_epsilon = _execute.make_float(variance_epsilon, "variance_epsilon")
  scale_after_normalization = _execute.make_bool(scale_after_normalization, "scale_after_normalization")
  _attr_T, _inputs_T = _execute.args_to_matching_eager([t, m, v, gamma, backprop], ctx)
...
def bias_add(value, bias, data_format="NHWC", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "BiasAdd", name,
...
def bias_add_eager_fallback(value, bias, data_format, name, ctx):
  if data_format is None:
    data_format = "NHWC"
  data_format = _execute.make_str(data_format, "data_format")
  _attr_T, _inputs_T = _execute.args_to_matching_eager([value, bias], ctx)
...
def bias_add_grad(out_backprop, data_format="NHWC", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "BiasAddGrad", name,
        tld.op_callbacks, out_backprop, "data_format", data_format)
      return _result
    except _core._FallbackException:
      try:
...
def bias_add_grad_eager_fallback(out_backprop, data_format, name, ctx):
  if data_format is None:
    data_format = "NHWC"
  data_format = _execute.make_str(data_format, "data_format")
  _attr_T, (out_backprop,) = _execute.args_to_matching_eager([out_backprop], ctx)
...
def bias_add_v1(value, bias, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "BiasAddV1", name,
        tld.op_callbacks, value, bias)
      return _result
    except _core._FallbackException:
      try:
...
def conv2d(input, filter, strides, padding, use_cudnn_on_gpu=True, explicit_paddings=[], data_format="NHWC", dilations=[1, 1, 1, 1], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Conv2D", name,
        tld.op_callbacks, input, filter, "strides", strides,
...
def conv2d_backprop_filter(input, filter_sizes, out_backprop, strides, padding, use_cudnn_on_gpu=True, explicit_paddings=[], data_format="NHWC", dilations=[1, 1, 1, 1], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Conv2DBackpropFilter", name,
        tld.op_callbacks, input, filter_sizes, out_backprop, "strides",
...
def conv2d_backprop_filter_eager_fallback(input, filter_sizes, out_backprop, strides, padding, use_cudnn_on_gpu, explicit_paddings, data_format, dilations, name, ctx):
  ...
  if not isinstance(dilations, (list, tuple)):
    raise TypeError(
        ...
        "'conv2d_backprop_filter' Op, not %r." % dilations)
  dilations = [_execute.make_int(_i, "dilations") for _i in dilations]
  _attr_T, _inputs_T = _execute.args_to_matching_eager([input, out_backprop], ctx)
...
def conv2d_backprop_input(input_sizes, filter, out_backprop, strides, padding, use_cudnn_on_gpu=True, explicit_paddings=[], data_format="NHWC", dilations=[1, 1, 1, 1], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Conv2DBackpropInput", name,
        tld.op_callbacks, input_sizes, filter, out_backprop, "strides",
        strides, "use_cudnn_on_gpu", use_cudnn_on_gpu, "padding", padding,
        "explicit_paddings", explicit_paddings, "data_format", data_format,
        "dilations", dilations)
      return _result
...
def conv2d_backprop_input_eager_fallback(input_sizes, filter, out_backprop, strides, padding, use_cudnn_on_gpu, explicit_paddings, data_format, dilations, name, ctx):
  ...
  if not isinstance(dilations, (list, tuple)):
    raise TypeError(
        ...
        "'conv2d_backprop_input' Op, not %r." % dilations)
  dilations = [_execute.make_int(_i, "dilations") for _i in dilations]
  _attr_T, _inputs_T = _execute.args_to_matching_eager([filter, out_backprop], ctx)
...
def conv3d(input, filter, strides, padding, data_format="NDHWC", dilations=[1, 1, 1, 1, 1], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Conv3D", name,
        tld.op_callbacks, input, filter, "strides", strides, "padding",
...
def conv3d_backprop_filter(input, filter, out_backprop, strides, padding, dilations=[1, 1, 1, 1, 1], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Conv3DBackpropFilter", name,
        tld.op_callbacks, input, filter, out_backprop, "strides", strides,
...
def conv3d_backprop_filter_v2(input, filter_sizes, out_backprop, strides, padding, data_format="NDHWC", dilations=[1, 1, 1, 1, 1], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Conv3DBackpropFilterV2", name,
        tld.op_callbacks, input, filter_sizes, out_backprop, "strides",
...
def conv3d_backprop_input(input, filter, out_backprop, strides, padding, dilations=[1, 1, 1, 1, 1], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Conv3DBackpropInput", name,
        tld.op_callbacks, input, filter, out_backprop, "strides", strides,
        "padding", padding, "dilations", dilations)
      return _result
    except _core._FallbackException:
...
def conv3d_backprop_input_v2(input_sizes, filter, out_backprop, strides, padding, data_format="NDHWC", dilations=[1, 1, 1, 1, 1], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Conv3DBackpropInputV2", name,
        tld.op_callbacks, input_sizes, filter, out_backprop, "strides",
        strides, "padding", padding, "data_format", data_format, "dilations",
        dilations)
      return _result
...
def conv3d_backprop_input_v2_eager_fallback(input_sizes, filter, out_backprop, strides, padding, data_format, dilations, name, ctx):
  ...
  _attr_T, _inputs_T = _execute.args_to_matching_eager([filter, out_backprop], ctx)
  (filter, out_backprop) = _inputs_T
  _attr_Tshape, (input_sizes,) = _execute.args_to_matching_eager([input_sizes], ctx, _dtypes.int32)
  _inputs_flat = [input_sizes, filter, out_backprop]
  _attrs = ("T", _attr_T, "strides", strides, "padding", padding,
...
def data_format_dim_map(x, src_format="NHWC", dst_format="NCHW", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DataFormatDimMap", name,
        tld.op_callbacks, x, "src_format", src_format, "dst_format",
        dst_format)
      return _result
    except _core._FallbackException:
      try:
...
def data_format_vec_permute(x, src_format="NHWC", dst_format="NCHW", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DataFormatVecPermute", name,
        tld.op_callbacks, x, "src_format", src_format, "dst_format",
        dst_format)
      return _result
    except _core._FallbackException:
...
def depthwise_conv2d_native(input, filter, strides, padding, data_format="NHWC", dilations=[1, 1, 1, 1], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DepthwiseConv2dNative", name,
        tld.op_callbacks, input, filter, "strides", strides, "padding",
        padding, "data_format", data_format, "dilations", dilations)
      return _result
    except _core._FallbackException:
...
def depthwise_conv2d_native_eager_fallback(input, filter, strides, padding, data_format, dilations, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'depthwise_conv2d_native' Op, not %r." % strides)
...
def depthwise_conv2d_native_backprop_filter(input, filter_sizes, out_backprop, strides, padding, data_format="NHWC", dilations=[1, 1, 1, 1], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "DepthwiseConv2dNativeBackpropFilter", name, tld.op_callbacks, input,
...
def depthwise_conv2d_native_backprop_filter_eager_fallback(input, filter_sizes, out_backprop, strides, padding, data_format, dilations, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'depthwise_conv2d_native_backprop_filter' Op, not %r." % strides)
...
def depthwise_conv2d_native_backprop_input(input_sizes, filter, out_backprop, strides, padding, data_format="NHWC", dilations=[1, 1, 1, 1], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "DepthwiseConv2dNativeBackpropInput", name, tld.op_callbacks,
...
def depthwise_conv2d_native_backprop_input_eager_fallback(input_sizes, filter, out_backprop, strides, padding, data_format, dilations, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'depthwise_conv2d_native_backprop_input' Op, not %r." % strides)
...
def elu(features, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Elu", name, tld.op_callbacks,
        features)
      return _result
    except _core._FallbackException:
      try:
...
def elu_eager_fallback(features, name, ctx):
  _attr_T, (features,) = _execute.args_to_matching_eager([features], ctx)
...
def elu_grad(gradients, outputs, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "EluGrad", name,
        tld.op_callbacks, gradients, outputs)
      return _result
    except _core._FallbackException:
      try:
...
def elu_grad_eager_fallback(gradients, outputs, name, ctx):
  _attr_T, _inputs_T = _execute.args_to_matching_eager([gradients, outputs], ctx)
...
def fractional_avg_pool(value, pooling_ratio, pseudo_random=False, overlapping=False, deterministic=False, seed=0, seed2=0, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FractionalAvgPool", name,
        tld.op_callbacks, value, "pooling_ratio", pooling_ratio,
...
def fractional_avg_pool_grad(orig_input_tensor_shape, out_backprop, row_pooling_sequence, col_pooling_sequence, overlapping=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FractionalAvgPoolGrad", name,
        tld.op_callbacks, orig_input_tensor_shape, out_backprop,
...
def fractional_max_pool(value, pooling_ratio, pseudo_random=False, overlapping=False, deterministic=False, seed=0, seed2=0, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FractionalMaxPool", name,
        tld.op_callbacks, value, "pooling_ratio", pooling_ratio,
        "pseudo_random", pseudo_random, "overlapping", overlapping,
        "deterministic", deterministic, "seed", seed, "seed2", seed2)
...
def fractional_max_pool_grad(orig_input, orig_output, out_backprop, row_pooling_sequence, col_pooling_sequence, overlapping=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FractionalMaxPoolGrad", name,
        tld.op_callbacks, orig_input, orig_output, out_backprop,
        row_pooling_sequence, col_pooling_sequence, "overlapping",
        overlapping)
      return _result
    except _core._FallbackException:
...
def fractional_max_pool_grad_eager_fallback(orig_input, orig_output, out_backprop, row_pooling_sequence, col_pooling_sequence, overlapping, name, ctx):
  if overlapping is None:
    overlapping = False
  overlapping = _execute.make_bool(overlapping, "overlapping")
  _attr_T, _inputs_T = _execute.args_to_matching_eager([orig_input, orig_output, out_backprop], ctx)
...
def _fused_batch_norm(x, scale, offset, mean, variance, epsilon=0.0001, data_format="NHWC", is_training=True, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FusedBatchNorm", name,
        tld.op_callbacks, x, scale, offset, mean, variance, "epsilon",
...
def _fused_batch_norm_eager_fallback(x, scale, offset, mean, variance, epsilon, data_format, is_training, name, ctx):
  if epsilon is None:
    epsilon = 0.0001
  epsilon = _execute.make_float(epsilon, "epsilon")
  if data_format is None:
  ...
  if is_training is None:
    is_training = True
  is_training = _execute.make_bool(is_training, "is_training")
  _attr_T, _inputs_T = _execute.args_to_matching_eager([x, scale, offset, mean, variance], ctx)
...
def fused_batch_norm_grad(y_backprop, x, scale, reserve_space_1, reserve_space_2, epsilon=0.0001, data_format="NHWC", is_training=True, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FusedBatchNormGrad", name,
        tld.op_callbacks, y_backprop, x, scale, reserve_space_1,
...
def fused_batch_norm_grad_eager_fallback(y_backprop, x, scale, reserve_space_1, reserve_space_2, epsilon, data_format, is_training, name, ctx):
  ...
  if is_training is None:
    is_training = True
  is_training = _execute.make_bool(is_training, "is_training")
  _attr_T, _inputs_T = _execute.args_to_matching_eager([y_backprop, x, scale, reserve_space_1, reserve_space_2], ctx)
...
def fused_batch_norm_grad_v2(y_backprop, x, scale, reserve_space_1, reserve_space_2, epsilon=0.0001, data_format="NHWC", is_training=True, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FusedBatchNormGradV2", name,
        tld.op_callbacks, y_backprop, x, scale, reserve_space_1,
        reserve_space_2, "epsilon", epsilon, "data_format", data_format,
        "is_training", is_training)
...
def fused_batch_norm_grad_v2_eager_fallback(y_backprop, x, scale, reserve_space_1, reserve_space_2, epsilon, data_format, is_training, name, ctx):
  ...
  if is_training is None:
    is_training = True
  is_training = _execute.make_bool(is_training, "is_training")
  _attr_T, _inputs_T = _execute.args_to_matching_eager([y_backprop, x], ctx)
  (y_backprop, x) = _inputs_T
  _attr_U, _inputs_U = _execute.args_to_matching_eager([reserve_space_1, reserve_space_2], ctx)
...
def fused_batch_norm_grad_v3(y_backprop, x, scale, reserve_space_1, reserve_space_2, reserve_space_3, epsilon=0.0001, data_format="NHWC", is_training=True, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FusedBatchNormGradV3", name,
        tld.op_callbacks, y_backprop, x, scale, reserve_space_1,
        reserve_space_2, reserve_space_3, "epsilon", epsilon, "data_format",
        data_format, "is_training", is_training)
...
def fused_batch_norm_grad_v3_eager_fallback(y_backprop, x, scale, reserve_space_1, reserve_space_2, reserve_space_3, epsilon, data_format, is_training, name, ctx):
  ...
  _attr_T, _inputs_T = _execute.args_to_matching_eager([y_backprop, x], ctx)
  (y_backprop, x) = _inputs_T
  _attr_U, _inputs_U = _execute.args_to_matching_eager([reserve_space_1, reserve_space_2, reserve_space_3], ctx)
...
def fused_batch_norm_v2(x, scale, offset, mean, variance, epsilon=0.0001, data_format="NHWC", is_training=True, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FusedBatchNormV2", name,
        tld.op_callbacks, x, scale, offset, mean, variance, "epsilon",
        epsilon, "data_format", data_format, "is_training", is_training)
...
def fused_batch_norm_v2_eager_fallback(x, scale, offset, mean, variance, epsilon, data_format, is_training, name, ctx):
  if epsilon is None:
    epsilon = 0.0001
  epsilon = _execute.make_float(epsilon, "epsilon")
  if data_format is None:
  ...
  _attr_U, _inputs_U = _execute.args_to_matching_eager([scale, offset, mean, variance], ctx)
...
def fused_batch_norm_v3(x, scale, offset, mean, variance, epsilon=0.0001, data_format="NHWC", is_training=True, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FusedBatchNormV3", name,
        tld.op_callbacks, x, scale, offset, mean, variance, "epsilon",
        epsilon, "data_format", data_format, "is_training", is_training)
...
def fused_batch_norm_v3_eager_fallback(x, scale, offset, mean, variance, epsilon, data_format, is_training, name, ctx):
  if epsilon is None:
    epsilon = 0.0001
  epsilon = _execute.make_float(epsilon, "epsilon")
  if data_format is None:
...
def fused_pad_conv2d(input, paddings, filter, mode, strides, padding, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FusedPadConv2D", name,
        tld.op_callbacks, input, paddings, filter, "mode", mode, "strides",
...
def fused_resize_and_pad_conv2d(input, size, paddings, filter, mode, strides, padding, resize_align_corners=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FusedResizeAndPadConv2D",
        name, tld.op_callbacks, input, size, paddings, filter,
...
def in_top_k(predictions, targets, k, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "InTopK", name,
        tld.op_callbacks, predictions, targets, "k", k)
      return _result
    except _core._FallbackException:
      try:
...
def in_top_k_eager_fallback(predictions, targets, k, name, ctx):
  k = _execute.make_int(k, "k")
  _attr_T, (targets,) = _execute.args_to_matching_eager([targets], ctx, _dtypes.int32)
...
def in_top_kv2(predictions, targets, k, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "InTopKV2", name,
        tld.op_callbacks, predictions, targets, k)
      return _result
    except _core._FallbackException:
      try:
...
def in_top_kv2_eager_fallback(predictions, targets, k, name, ctx):
  _attr_T, _inputs_T = _execute.args_to_matching_eager([targets, k], ctx, _dtypes.int32)
  (targets, k) = _inputs_T
  predictions = _ops.convert_to_tensor(predictions, _dtypes.float32)
...
def l2_loss(t, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "L2Loss", name,
        tld.op_callbacks, t)
      return _result
    except _core._FallbackException:
      try:
...
def l2_loss_eager_fallback(t, name, ctx):
  _attr_T, (t,) = _execute.args_to_matching_eager([t], ctx)
  _inputs_flat = [t]
  _attrs = ("T", _attr_T)
...
def lrn(input, depth_radius=5, bias=1, alpha=1, beta=0.5, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "LRN", name, tld.op_callbacks,
...
def lrn_eager_fallback(input, depth_radius, bias, alpha, beta, name, ctx):
  ...
  if beta is None:
    beta = 0.5
  beta = _execute.make_float(beta, "beta")
  _attr_T, (input,) = _execute.args_to_matching_eager([input], ctx, _dtypes.float32)
  _inputs_flat = [input]
...
def lrn_grad(input_grads, input_image, output_image, depth_radius=5, bias=1, alpha=1, beta=0.5, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "LRNGrad", name,
        tld.op_callbacks, input_grads, input_image, output_image,
...
def lrn_grad_eager_fallback(input_grads, input_image, output_image, depth_radius, bias, alpha, beta, name, ctx):
  ...
  if beta is None:
    beta = 0.5
  beta = _execute.make_float(beta, "beta")
  _attr_T, _inputs_T = _execute.args_to_matching_eager([input_grads, input_image, output_image], ctx, _dtypes.float32)
...
def leaky_relu(features, alpha=0.2, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "LeakyRelu", name,
        tld.op_callbacks, features, "alpha", alpha)
      return _result
    except _core._FallbackException:
      try:
...
def leaky_relu_eager_fallback(features, alpha, name, ctx):
  if alpha is None:
    alpha = 0.2
  alpha = _execute.make_float(alpha, "alpha")
  _attr_T, (features,) = _execute.args_to_matching_eager([features], ctx, _dtypes.float32)
  _inputs_flat = [features]
...
def leaky_relu_grad(gradients, features, alpha=0.2, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "LeakyReluGrad", name,
        tld.op_callbacks, gradients, features, "alpha", alpha)
      return _result
    except _core._FallbackException:
      try:
...
def leaky_relu_grad_eager_fallback(gradients, features, alpha, name, ctx):
  if alpha is None:
    alpha = 0.2
  alpha = _execute.make_float(alpha, "alpha")
  _attr_T, _inputs_T = _execute.args_to_matching_eager([gradients, features], ctx, _dtypes.float32)
...
def log_softmax(logits, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "LogSoftmax", name,
        tld.op_callbacks, logits)
      return _result
    except _core._FallbackException:
      try:
...
def max_pool(input, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MaxPool", name,
        tld.op_callbacks, input, "ksize", ksize, "strides", strides,
        "padding", padding, "data_format", data_format)
      return _result
    except _core._FallbackException:
...
def max_pool_eager_fallback(input, ksize, strides, padding, data_format, name, ctx):
  if not isinstance(ksize, (list, tuple)):
    raise TypeError(
        "Expected list for 'ksize' argument to "
        "'max_pool' Op, not %r." % ksize)
...
def max_pool3d(input, ksize, strides, padding, data_format="NDHWC", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MaxPool3D", name,
        tld.op_callbacks, input, "ksize", ksize, "strides", strides,
        "padding", padding, "data_format", data_format)
      return _result
    except _core._FallbackException:
...
def max_pool3d_grad(orig_input, orig_output, grad, ksize, strides, padding, data_format="NDHWC", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MaxPool3DGrad", name,
        tld.op_callbacks, orig_input, orig_output, grad, "ksize", ksize,
...
def max_pool3d_grad_eager_fallback(orig_input, orig_output, grad, ksize, strides, padding, data_format, name, ctx):
  ...
  if data_format is None:
    data_format = "NDHWC"
  data_format = _execute.make_str(data_format, "data_format")
  _attr_T, (grad,) = _execute.args_to_matching_eager([grad], ctx, _dtypes.float32)
  _attr_TInput, _inputs_TInput = _execute.args_to_matching_eager([orig_input, orig_output], ctx, _dtypes.float32)
...
def max_pool3d_grad_grad(orig_input, orig_output, grad, ksize, strides, padding, data_format="NDHWC", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MaxPool3DGradGrad", name,
        tld.op_callbacks, orig_input, orig_output, grad, "ksize", ksize,
        "strides", strides, "padding", padding, "data_format", data_format)
      return _result
    except _core._FallbackException:
...
def max_pool3d_grad_grad_eager_fallback(orig_input, orig_output, grad, ksize, strides, padding, data_format, name, ctx):
  ...
  if data_format is None:
    data_format = "NDHWC"
  data_format = _execute.make_str(data_format, "data_format")
  _attr_T, _inputs_T = _execute.args_to_matching_eager([orig_input, orig_output, grad], ctx)
...
def max_pool_grad(orig_input, orig_output, grad, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MaxPoolGrad", name,
        tld.op_callbacks, orig_input, orig_output, grad, "ksize", ksize,
        "strides", strides, "padding", padding, "data_format", data_format)
      return _result
    except _core._FallbackException:
...
def max_pool_grad_eager_fallback(orig_input, orig_output, grad, ksize, strides, padding, data_format, name, ctx):
  if not isinstance(ksize, (list, tuple)):
    raise TypeError(
        "Expected list for 'ksize' argument to "
        "'max_pool_grad' Op, not %r." % ksize)
  ...
  if data_format is None:
    data_format = "NHWC"
  data_format = _execute.make_str(data_format, "data_format")
  _attr_T, _inputs_T = _execute.args_to_matching_eager([orig_input, orig_output, grad], ctx, _dtypes.float32)
  (orig_input, orig_output, grad) = _inputs_T
  _inputs_flat = [orig_input, orig_output, grad]
  _attrs = ("ksize", ksize, "strides", strides, "padding", padding,
  "data_format", data_format, "T", _attr_T)
...
def max_pool_grad_grad(orig_input, orig_output, grad, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MaxPoolGradGrad", name,
        tld.op_callbacks, orig_input, orig_output, grad, "ksize", ksize,
        "strides", strides, "padding", padding, "data_format", data_format)
      return _result
    except _core._FallbackException:
...
def max_pool_grad_grad_v2(orig_input, orig_output, grad, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MaxPoolGradGradV2", name,
        tld.op_callbacks, orig_input, orig_output, grad, ksize, strides,
        "padding", padding, "data_format", data_format)
      return _result
    except _core._FallbackException:
      try:
...
def max_pool_grad_grad_with_argmax(input, grad, argmax, ksize, strides, padding, include_batch_in_index=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MaxPoolGradGradWithArgmax",
        name, tld.op_callbacks, input, grad, argmax, "ksize", ksize,
        "strides", strides, "padding", padding, "include_batch_in_index",
...
def max_pool_grad_grad_with_argmax_eager_fallback(input, grad, argmax, ksize, strides, padding, include_batch_in_index, name, ctx):
  ...
  if include_batch_in_index is None:
    include_batch_in_index = False
  include_batch_in_index = _execute.make_bool(include_batch_in_index, "include_batch_in_index")
  _attr_Targmax, (argmax,) = _execute.args_to_matching_eager([argmax], ctx)
  _attr_T, _inputs_T = _execute.args_to_matching_eager([input, grad], ctx)
...
def max_pool_grad_v2(orig_input, orig_output, grad, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MaxPoolGradV2", name,
        tld.op_callbacks, orig_input, orig_output, grad, ksize, strides,
        "padding", padding, "data_format", data_format)
      return _result
    except _core._FallbackException:
...
def max_pool_grad_with_argmax(input, grad, argmax, ksize, strides, padding, include_batch_in_index=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MaxPoolGradWithArgmax", name,
        tld.op_callbacks, input, grad, argmax, "ksize", ksize, "strides",
        strides, "padding", padding, "include_batch_in_index",
        include_batch_in_index)
      return _result
    except _core._FallbackException:
      try:
...
def max_pool_v2(input, ksize, strides, padding, data_format="NHWC", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MaxPoolV2", name,
        tld.op_callbacks, input, ksize, strides, "padding", padding,
        "data_format", data_format)
      return _result
    except _core._FallbackException:
      try:
...
def max_pool_with_argmax(input, ksize, strides, padding, Targmax=_dtypes.int64, include_batch_in_index=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MaxPoolWithArgmax", name,
        tld.op_callbacks, input, "ksize", ksize, "strides", strides,
        "Targmax", Targmax, "padding", padding, "include_batch_in_index",
        include_batch_in_index)
...
def nth_element(input, n, reverse=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "NthElement", name,
        tld.op_callbacks, input, n, "reverse", reverse)
      return _result
    except _core._FallbackException:
      try:
...
def quantized_avg_pool(input, min_input, max_input, ksize, strides, padding, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "QuantizedAvgPool", name,
        tld.op_callbacks, input, min_input, max_input, "ksize", ksize,
        "strides", strides, "padding", padding)
...
def quantized_batch_norm_with_global_normalization(t, t_min, t_max, m, m_min, m_max, v, v_min, v_max, beta, beta_min, beta_max, gamma, gamma_min, gamma_max, out_type, variance_epsilon, scale_after_normalization, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "QuantizedBatchNormWithGlobalNormalization", name, tld.op_callbacks,
...
def quantized_batch_norm_with_global_normalization_eager_fallback(t, t_min, t_max, m, m_min, m_max, v, v_min, v_max, beta, beta_min, beta_max, gamma, gamma_min, gamma_max, out_type, variance_epsilon, scale_after_normalization, name, ctx):
  ...
  variance_epsilon = _execute.make_float(variance_epsilon, "variance_epsilon")
  scale_after_normalization = _execute.make_bool(scale_after_normalization, "scale_after_normalization")
  _attr_Tinput, _inputs_Tinput = _execute.args_to_matching_eager([t, m, v, beta, gamma], ctx)
...
def quantized_bias_add(input, bias, min_input, max_input, min_bias, max_bias, out_type, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "QuantizedBiasAdd", name,
        tld.op_callbacks, input, bias, min_input, max_input, min_bias,
        max_bias, "out_type", out_type)
...
def quantized_bias_add_eager_fallback(input, bias, min_input, max_input, min_bias, max_bias, out_type, name, ctx):
  out_type = _execute.make_type(out_type, "out_type")
  _attr_T1, (input,) = _execute.args_to_matching_eager([input], ctx)
  _attr_T2, (bias,) = _execute.args_to_matching_eager([bias], ctx)
  min_input = _ops.convert_to_tensor(min_input, _dtypes.float32)
  max_input = _ops.convert_to_tensor(max_input, _dtypes.float32)
...
def quantized_conv2d(input, filter, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "QuantizedConv2D", name,
        tld.op_callbacks, input, filter, min_input, max_input, min_filter,
        max_filter, "out_type", out_type, "strides", strides, "padding",
        padding, "dilations", dilations)
...
def quantized_conv2d_eager_fallback(input, filter, min_input, max_input, min_filter, max_filter, strides, padding, out_type, dilations, name, ctx):
  ...
  _attr_Tfilter, (filter,) = _execute.args_to_matching_eager([filter], ctx)
  min_input = _ops.convert_to_tensor(min_input, _dtypes.float32)
  max_input = _ops.convert_to_tensor(max_input, _dtypes.float32)
...
def quantized_conv2d_and_relu(input, filter, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "QuantizedConv2DAndRelu", name,
        tld.op_callbacks, input, filter, min_input, max_input, min_filter,
        max_filter, "out_type", out_type, "strides", strides, "padding",
...
def quantized_conv2d_and_relu_and_requantize(input, filter, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding, out_type=_dtypes.quint8, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "QuantizedConv2DAndReluAndRequantize", name, tld.op_callbacks, input,
        filter, min_input, max_input, min_filter, max_filter,
...
def quantized_conv2d_and_requantize(input, filter, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding, out_type=_dtypes.qint8, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "QuantizedConv2DAndRequantize",
        name, tld.op_callbacks, input, filter, min_input, max_input,
...
def quantized_conv2d_per_channel(input, filter, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "QuantizedConv2DPerChannel",
        name, tld.op_callbacks, input, filter, min_input, max_input,
...
def quantized_conv2d_with_bias(input, filter, bias, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "QuantizedConv2DWithBias",
        name, tld.op_callbacks, input, filter, bias, min_input, max_input,
        min_filter, max_filter, "out_type", out_type, "strides", strides,
...
def quantized_conv2d_with_bias_and_relu(input, filter, bias, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "QuantizedConv2DWithBiasAndRelu", name, tld.op_callbacks, input,
...
def quantized_conv2d_with_bias_and_relu_and_requantize(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding, out_type=_dtypes.quint8, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "QuantizedConv2DWithBiasAndReluAndRequantize", name, tld.op_callbacks,
        input, filter, bias, min_input, max_input, min_filter, max_filter,
        min_freezed_output, max_freezed_output, "out_type", out_type,
        "strides", strides, "padding", padding, "dilations", dilations,
        "padding_list", padding_list)
...
def quantized_conv2d_with_bias_and_relu_and_requantize_eager_fallback(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding, out_type, dilations, padding_list, name, ctx):
  ...
  _attr_Tinput, (input,) = _execute.args_to_matching_eager([input], ctx)
  _attr_Tfilter, (filter,) = _execute.args_to_matching_eager([filter], ctx)
  _attr_Tbias, (bias,) = _execute.args_to_matching_eager([bias], ctx)
  min_input = _ops.convert_to_tensor(min_input, _dtypes.float32)
  max_input = _ops.convert_to_tensor(max_input, _dtypes.float32)
  min_filter = _ops.convert_to_tensor(min_filter, _dtypes.float32)
  max_filter = _ops.convert_to_tensor(max_filter, _dtypes.float32)
...
def quantized_conv2d_with_bias_and_requantize(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding, out_type=_dtypes.qint8, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "QuantizedConv2DWithBiasAndRequantize", name, tld.op_callbacks, input,
        filter, bias, min_input, max_input, min_filter, max_filter,
        min_freezed_output, max_freezed_output, "out_type", out_type,
        "strides", strides, "padding", padding, "dilations", dilations,
        "padding_list", padding_list)
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        tld.op_callbacks, input, filter, bias, min_input, max_input,
        min_filter, max_filter, min_freezed_output, max_freezed_output,
        summand, min_summand, max_summand, "out_type", out_type, "strides",
...
def quantized_conv2d_with_bias_signed_sum_and_relu_and_requantize_eager_fallback(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, summand, min_summand, max_summand, strides, padding, out_type, dilations, padding_list, name, ctx):
  ...
  _attr_Tfilter, (filter,) = _execute.args_to_matching_eager([filter], ctx)
  _attr_Tbias, (bias,) = _execute.args_to_matching_eager([bias], ctx)
  _attr_Tsummand, (summand,) = _execute.args_to_matching_eager([summand], ctx)
  min_input = _ops.convert_to_tensor(min_input, _dtypes.float32)
  max_input = _ops.convert_to_tensor(max_input, _dtypes.float32)
  min_filter = _ops.convert_to_tensor(min_filter, _dtypes.float32)
  max_filter = _ops.convert_to_tensor(max_filter, _dtypes.float32)
...
def quantized_conv2d_with_bias_sum_and_relu(input, filter, bias, min_input, max_input, min_filter, max_filter, summand, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], padding_list=[], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "QuantizedConv2DWithBiasSumAndRelu", name, tld.op_callbacks, input,
        filter, bias, min_input, max_input, min_filter, max_filter, summand,
        "out_type", out_type, "strides", strides, "padding", padding,
        "dilations", dilations, "padding_list", padding_list)
...
def quantized_depthwise_conv2d(input, filter, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "QuantizedDepthwiseConv2D",
        name, tld.op_callbacks, input, filter, min_input, max_input,
        min_filter, max_filter, "out_type", out_type, "strides", strides,
        "padding", padding, "dilations", dilations)
...
def quantized_depthwise_conv2d_with_bias(input, filter, bias, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "QuantizedDepthwiseConv2DWithBias", name, tld.op_callbacks, input,
        filter, bias, min_input, max_input, min_filter, max_filter,
        "out_type", out_type, "strides", strides, "padding", padding,
        "dilations", dilations)
...
def quantized_depthwise_conv2d_with_bias_and_relu(input, filter, bias, min_input, max_input, min_filter, max_filter, strides, padding, out_type=_dtypes.qint32, dilations=[1, 1, 1, 1], name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "QuantizedDepthwiseConv2DWithBiasAndRelu", name, tld.op_callbacks,
        input, filter, bias, min_input, max_input, min_filter, max_filter,
        "out_type", out_type, "strides", strides, "padding", padding,
        "dilations", dilations)
...
def quantized_depthwise_conv2d_with_bias_and_relu_eager_fallback(input, filter, bias, min_input, max_input, min_filter, max_filter, strides, padding, out_type, dilations, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'quantized_depthwise_conv2d_with_bias_and_relu' Op, not %r." % strides)
...
def quantized_depthwise_conv2d_with_bias_and_relu_and_requantize_eager_fallback(input, filter, bias, min_input, max_input, min_filter, max_filter, min_freezed_output, max_freezed_output, strides, padding, out_type, dilations, name, ctx):
  if not isinstance(strides, (list, tuple)):
    raise TypeError(
        "Expected list for 'strides' argument to "
        "'quantized_depthwise_conv2d_with_bias_and_relu_and_requantize' Op, not %r." % strides)
...
add.
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "QuantizedMatMulWithBias",
        name, tld.op_callbacks, a, b, bias, min_a, max_a, min_b, max_b,
...
add and relu fusion.
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "QuantizedMatMulWithBiasAndRelu", name, tld.op_callbacks, a, b, bias,
        min_a, max_a, min_b, max_b, "Toutput", Toutput, "transpose_a",
...
add and relu and requantize fusion.
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "QuantizedMatMulWithBiasAndReluAndRequantize", name, tld.op_callbacks,
...
def quantized_max_pool(input, min_input, max_input, ksize, strides, padding, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "QuantizedMaxPool", name,
        tld.op_callbacks, input, min_input, max_input, "ksize", ksize,
        "strides", strides, "padding", padding)
...
def quantized_relu(features, min_features, max_features, out_type=_dtypes.quint8, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "QuantizedRelu", name,
        tld.op_callbacks, features, min_features, max_features, "out_type",
        out_type)
...
def quantized_relu_eager_fallback(features, min_features, max_features, out_type, name, ctx):
  if out_type is None:
    out_type = _dtypes.quint8
  out_type = _execute.make_type(out_type, "out_type")
  _attr_Tinput, (features,) = _execute.args_to_matching_eager([features], ctx)
...
def quantized_relu6(features, min_features, max_features, out_type=_dtypes.quint8, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "QuantizedRelu6", name,
        tld.op_callbacks, features, min_features, max_features, "out_type",
        out_type)
...
def quantized_relu_x(features, max_value, min_features, max_features, out_type=_dtypes.quint8, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "QuantizedReluX", name,
        tld.op_callbacks, features, max_value, min_features, max_features,
        "out_type", out_type)
...
def relu(features, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Relu", name, tld.op_callbacks,
        features)
      return _result
    except _core._FallbackException:
      try:
...
def relu6(features, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Relu6", name,
        tld.op_callbacks, features)
      return _result
    except _core._FallbackException:
      try:
...
def relu6_grad(gradients, features, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Relu6Grad", name,
        tld.op_callbacks, gradients, features)
      return _result
    except _core._FallbackException:
      try:
...
def relu6_grad_eager_fallback(gradients, features, name, ctx):
  _attr_T, _inputs_T = _execute.args_to_matching_eager([gradients, features], ctx)
  (gradients, features) = _inputs_T
  _inputs_flat = [gradients, features]
  _attrs = ("T", _attr_T)
...
def relu_grad(gradients, features, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ReluGrad", name,
        tld.op_callbacks, gradients, features)
      return _result
    except _core._FallbackException:
      try:
...
def selu(features, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Selu", name, tld.op_callbacks,
        features)
      return _result
    except _core._FallbackException:
      try:
...
def selu_grad(gradients, outputs, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SeluGrad", name,
        tld.op_callbacks, gradients, outputs)
      return _result
    except _core._FallbackException:
      try:
...
def softmax(logits, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Softmax", name,
        tld.op_callbacks, logits)
      return _result
    except _core._FallbackException:
      try:
...
def softmax_cross_entropy_with_logits(features, labels, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "SoftmaxCrossEntropyWithLogits", name, tld.op_callbacks, features,
        labels)
...
def softmax_cross_entropy_with_logits_eager_fallback(features, labels, name, ctx):
  _attr_T, _inputs_T = _execute.args_to_matching_eager([features, labels], ctx)
...
def softplus(features, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Softplus", name,
        tld.op_callbacks, features)
      return _result
    except _core._FallbackException:
      try:
...
def softplus_grad(gradients, features, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SoftplusGrad", name,
        tld.op_callbacks, gradients, features)
      return _result
    except _core._FallbackException:
      try:
...
def softsign(features, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Softsign", name,
        tld.op_callbacks, features)
      return _result
    except _core._FallbackException:
      try:
...
def softsign_grad(gradients, features, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SoftsignGrad", name,
        tld.op_callbacks, gradients, features)
      return _result
    except _core._FallbackException:
      try:
...
def sparse_softmax_cross_entropy_with_logits(features, labels, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "SparseSoftmaxCrossEntropyWithLogits", name, tld.op_callbacks,
        features, labels)
...
def sparse_softmax_cross_entropy_with_logits_eager_fallback(features, labels, name, ctx):
  _attr_T, (features,) = _execute.args_to_matching_eager([features], ctx)
  _attr_Tlabels, (labels,) = _execute.args_to_matching_eager([labels], ctx, _dtypes.int64)
  _inputs_flat = [features, labels]
...
def top_k(input, k, sorted=True, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TopK", name, tld.op_callbacks,
        input, "k", k, "sorted", sorted)
...
def top_kv2(input, k, sorted=True, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TopKV2", name,
        tld.op_callbacks, input, k, "sorted", sorted)
