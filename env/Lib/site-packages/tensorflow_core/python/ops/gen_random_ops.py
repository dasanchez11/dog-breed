  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Multinomial", name,
        tld.op_callbacks, logits, num_samples, "seed", seed, "seed2", seed2,
...
def parameterized_truncated_normal(shape, means, stdevs, minvals, maxvals, seed=0, seed2=0, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ParameterizedTruncatedNormal",
        name, tld.op_callbacks, shape, means, stdevs, minvals, maxvals,
...
def parameterized_truncated_normal_eager_fallback(shape, means, stdevs, minvals, maxvals, seed, seed2, name, ctx):
  ...
  if seed2 is None:
    seed2 = 0
  seed2 = _execute.make_int(seed2, "seed2")
  _attr_dtype, _inputs_dtype = _execute.args_to_matching_eager([means, stdevs, minvals, maxvals], ctx)
...
def random_gamma(shape, alpha, seed=0, seed2=0, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "RandomGamma", name,
        tld.op_callbacks, shape, alpha, "seed", seed, "seed2", seed2)
      return _result
    except _core._FallbackException:
      try:
...
def random_gamma_eager_fallback(shape, alpha, seed, seed2, name, ctx):
  ...
  _attr_T, (alpha,) = _execute.args_to_matching_eager([alpha], ctx)
...
def random_gamma_grad(alpha, sample, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "RandomGammaGrad", name,
        tld.op_callbacks, alpha, sample)
      return _result
    except _core._FallbackException:
      try:
...
def random_gamma_grad_eager_fallback(alpha, sample, name, ctx):
  _attr_T, _inputs_T = _execute.args_to_matching_eager([alpha, sample], ctx)
...
def random_poisson(shape, rate, seed=0, seed2=0, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "RandomPoisson", name,
        tld.op_callbacks, shape, rate, "seed", seed, "seed2", seed2)
      return _result
    except _core._FallbackException:
      try:
...
def random_poisson_eager_fallback(shape, rate, seed, seed2, name, ctx):
  ...
  seed2 = _execute.make_int(seed2, "seed2")
  _attr_S, (shape,) = _execute.args_to_matching_eager([shape], ctx)
  _attr_dtype, (rate,) = _execute.args_to_matching_eager([rate], ctx)
...
def random_poisson_v2(shape, rate, seed=0, seed2=0, dtype=_dtypes.int64, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "RandomPoissonV2", name,
        tld.op_callbacks, shape, rate, "seed", seed, "seed2", seed2, "dtype",
        dtype)
      return _result
    except _core._FallbackException:
      try:
...
def random_poisson_v2_eager_fallback(shape, rate, seed, seed2, dtype, name, ctx):
  ...
  dtype = _execute.make_type(dtype, "dtype")
  _attr_S, (shape,) = _execute.args_to_matching_eager([shape], ctx)
  _attr_R, (rate,) = _execute.args_to_matching_eager([rate], ctx, _dtypes.float64)
  _inputs_flat = [shape, rate]
...
def random_shuffle(value, seed=0, seed2=0, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "RandomShuffle", name,
        tld.op_callbacks, value, "seed", seed, "seed2", seed2)
      return _result
    except _core._FallbackException:
      try:
...
def random_standard_normal(shape, dtype, seed=0, seed2=0, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "RandomStandardNormal", name,
        tld.op_callbacks, shape, "seed", seed, "seed2", seed2, "dtype", dtype)
      return _result
    except _core._FallbackException:
      try:
...
def random_uniform(shape, dtype, seed=0, seed2=0, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "RandomUniform", name,
        tld.op_callbacks, shape, "seed", seed, "seed2", seed2, "dtype", dtype)
      return _result
    except _core._FallbackException:
      try:
...
def random_uniform_int(shape, minval, maxval, seed=0, seed2=0, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "RandomUniformInt", name,
        tld.op_callbacks, shape, minval, maxval, "seed", seed, "seed2", seed2)
      return _result
    except _core._FallbackException:
      try:
...
def random_uniform_int_eager_fallback(shape, minval, maxval, seed, seed2, name, ctx):
  ...
  if seed2 is None:
    seed2 = 0
  seed2 = _execute.make_int(seed2, "seed2")
  _attr_Tout, _inputs_Tout = _execute.args_to_matching_eager([minval, maxval], ctx)
...
def truncated_normal(shape, dtype, seed=0, seed2=0, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TruncatedNormal", name,
        tld.op_callbacks, shape, "seed", seed, "seed2", seed2, "dtype", dtype)
      return _result
    except _core._FallbackException:
      try:
