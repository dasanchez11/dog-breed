  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "EmptyTensorList", name,
        tld.op_callbacks, element_shape, max_num_elements, "element_dtype",
        element_dtype)
      return _result
...
def empty_tensor_list_eager_fallback(element_shape, max_num_elements, element_dtype, name, ctx):
  element_dtype = _execute.make_type(element_dtype, "element_dtype")
  _attr_shape_type, (element_shape,) = _execute.args_to_matching_eager([element_shape], ctx)
...
def tensor_list_concat(input_handle, element_dtype, element_shape=None, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListConcat", name,
        tld.op_callbacks, input_handle, "element_dtype", element_dtype,
...
def tensor_list_concat_lists(input_a, input_b, element_dtype, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListConcatLists", name,
        tld.op_callbacks, input_a, input_b, "element_dtype", element_dtype)
      return _result
    except _core._FallbackException:
      try:
...
def tensor_list_concat_v2(input_handle, element_shape, leading_dims, element_dtype, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListConcatV2", name,
        tld.op_callbacks, input_handle, element_shape, leading_dims,
        "element_dtype", element_dtype)
...
def tensor_list_element_shape(input_handle, shape_type, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListElementShape", name,
        tld.op_callbacks, input_handle, "shape_type", shape_type)
      return _result
    except _core._FallbackException:
      try:
...
def tensor_list_from_tensor(tensor, element_shape, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListFromTensor", name,
        tld.op_callbacks, tensor, element_shape)
      return _result
    except _core._FallbackException:
      try:
...
def tensor_list_gather(input_handle, indices, element_shape, element_dtype, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListGather", name,
        tld.op_callbacks, input_handle, indices, element_shape,
        "element_dtype", element_dtype)
      return _result
    except _core._FallbackException:
      try:
...
def tensor_list_get_item(input_handle, index, element_shape, element_dtype, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListGetItem", name,
        tld.op_callbacks, input_handle, index, element_shape, "element_dtype",
        element_dtype)
      return _result
    except _core._FallbackException:
      try:
...
def tensor_list_length(input_handle, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListLength", name,
...
def tensor_list_pop_back(input_handle, element_shape, element_dtype, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListPopBack", name,
        tld.op_callbacks, input_handle, element_shape, "element_dtype",
        element_dtype)
...
def tensor_list_push_back(input_handle, tensor, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListPushBack", name,
        tld.op_callbacks, input_handle, tensor)
      return _result
    except _core._FallbackException:
      try:
...
def tensor_list_push_back_batch(input_handles, tensor, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListPushBackBatch",
        name, tld.op_callbacks, input_handles, tensor)
      return _result
    except _core._FallbackException:
      try:
...
def tensor_list_reserve(element_shape, num_elements, element_dtype, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListReserve", name,
        tld.op_callbacks, element_shape, num_elements, "element_dtype",
        element_dtype)
      return _result
    except _core._FallbackException:
      try:
...
def tensor_list_resize(input_handle, size, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListResize", name,
        tld.op_callbacks, input_handle, size)
      return _result
    except _core._FallbackException:
      try:
...
def tensor_list_scatter(tensor, indices, element_shape, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListScatter", name,
        tld.op_callbacks, tensor, indices, element_shape)
      return _result
    except _core._FallbackException:
      try:
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "TensorListScatterIntoExistingList", name, tld.op_callbacks,
...
def tensor_list_scatter_v2(tensor, indices, element_shape, num_elements, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListScatterV2", name,
        tld.op_callbacks, tensor, indices, element_shape, num_elements)
      return _result
    except _core._FallbackException:
      try:
...
def tensor_list_set_item(input_handle, index, item, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListSetItem", name,
        tld.op_callbacks, input_handle, index, item)
      return _result
    except _core._FallbackException:
      try:
...
def tensor_list_split(tensor, element_shape, lengths, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListSplit", name,
        tld.op_callbacks, tensor, element_shape, lengths)
      return _result
    except _core._FallbackException:
      try:
...
def tensor_list_stack(input_handle, element_shape, element_dtype, num_elements=-1, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TensorListStack", name,
        tld.op_callbacks, input_handle, element_shape, "element_dtype",
