  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "AddManySparseToTensorsMap",
        name, tld.op_callbacks, sparse_indices, sparse_values, sparse_shape,
...
def add_sparse_to_tensors_map(sparse_indices, sparse_values, sparse_shape, container="", shared_name="", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "AddSparseToTensorsMap", name,
        tld.op_callbacks, sparse_indices, sparse_values, sparse_shape,
        "container", container, "shared_name", shared_name)
      return _result
    except _core._FallbackException:
      try:
...
def deserialize_many_sparse(serialized_sparse, dtype, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DeserializeManySparse", name,
        tld.op_callbacks, serialized_sparse, "dtype", dtype)
...
def deserialize_sparse(serialized_sparse, dtype, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DeserializeSparse", name,
        tld.op_callbacks, serialized_sparse, "dtype", dtype)
...
def deserialize_sparse_eager_fallback(serialized_sparse, dtype, name, ctx):
  dtype = _execute.make_type(dtype, "dtype")
  _attr_Tserialized, (serialized_sparse,) = _execute.args_to_matching_eager([serialized_sparse], ctx, _dtypes.string)
  _inputs_flat = [serialized_sparse]
...
def serialize_many_sparse(sparse_indices, sparse_values, sparse_shape, out_type=_dtypes.string, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SerializeManySparse", name,
        tld.op_callbacks, sparse_indices, sparse_values, sparse_shape,
        "out_type", out_type)
      return _result
    except _core._FallbackException:
...
def serialize_sparse(sparse_indices, sparse_values, sparse_shape, out_type=_dtypes.string, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SerializeSparse", name,
        tld.op_callbacks, sparse_indices, sparse_values, sparse_shape,
        "out_type", out_type)
      return _result
    except _core._FallbackException:
...
def sparse_add(a_indices, a_values, a_shape, b_indices, b_values, b_shape, thresh, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseAdd", name,
        tld.op_callbacks, a_indices, a_values, a_shape, b_indices, b_values,
        b_shape, thresh)
...
def sparse_add_eager_fallback(a_indices, a_values, a_shape, b_indices, b_values, b_shape, thresh, name, ctx):
  _attr_T, _inputs_T = _execute.args_to_matching_eager([a_values, b_values], ctx)
  (a_values, b_values) = _inputs_T
  _attr_Treal, (thresh,) = _execute.args_to_matching_eager([thresh], ctx)
...
def sparse_add_grad(backprop_val_grad, a_indices, b_indices, sum_indices, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseAddGrad", name,
        tld.op_callbacks, backprop_val_grad, a_indices, b_indices,
        sum_indices)
...
def sparse_add_grad_eager_fallback(backprop_val_grad, a_indices, b_indices, sum_indices, name, ctx):
  _attr_T, (backprop_val_grad,) = _execute.args_to_matching_eager([backprop_val_grad], ctx)
  a_indices = _ops.convert_to_tensor(a_indices, _dtypes.int64)
  b_indices = _ops.convert_to_tensor(b_indices, _dtypes.int64)
...
def sparse_concat(indices, values, shapes, concat_dim, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseConcat", name,
        tld.op_callbacks, indices, values, shapes, "concat_dim", concat_dim)
...
def sparse_cross(indices, values, shapes, dense_inputs, hashed_output, num_buckets, hash_key, out_type, internal_type, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseCross", name,
        tld.op_callbacks, indices, values, shapes, dense_inputs,
...
def sparse_dense_cwise_add(sp_indices, sp_values, sp_shape, dense, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseDenseCwiseAdd", name,
        tld.op_callbacks, sp_indices, sp_values, sp_shape, dense)
      return _result
    except _core._FallbackException:
      try:
...
def sparse_dense_cwise_add_eager_fallback(sp_indices, sp_values, sp_shape, dense, name, ctx):
  _attr_T, _inputs_T = _execute.args_to_matching_eager([sp_values, dense], ctx)
...
def sparse_dense_cwise_div(sp_indices, sp_values, sp_shape, dense, name=None):
  ...
  *Limitation*: this Op only broadcasts the dense side to the sparse side, but not
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseDenseCwiseDiv", name,
        tld.op_callbacks, sp_indices, sp_values, sp_shape, dense)
      return _result
    except _core._FallbackException:
      try:
...
def sparse_dense_cwise_mul(sp_indices, sp_values, sp_shape, dense, name=None):
  ...
  *Limitation*: this Op only broadcasts the dense side to the sparse side, but not
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseDenseCwiseMul", name,
        tld.op_callbacks, sp_indices, sp_values, sp_shape, dense)
      return _result
    except _core._FallbackException:
      try:
...
def sparse_fill_empty_rows(indices, values, dense_shape, default_value, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseFillEmptyRows", name,
        tld.op_callbacks, indices, values, dense_shape, default_value)
...
def sparse_fill_empty_rows_grad(reverse_index_map, grad_values, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseFillEmptyRowsGrad",
        name, tld.op_callbacks, reverse_index_map, grad_values)
...
def sparse_reduce_max(input_indices, input_values, input_shape, reduction_axes, keep_dims=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseReduceMax", name,
        tld.op_callbacks, input_indices, input_values, input_shape,
        reduction_axes, "keep_dims", keep_dims)
      return _result
    except _core._FallbackException:
      try:
...
def sparse_reduce_max_sparse(input_indices, input_values, input_shape, reduction_axes, keep_dims=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseReduceMaxSparse", name,
        tld.op_callbacks, input_indices, input_values, input_shape,
        reduction_axes, "keep_dims", keep_dims)
...
def sparse_reduce_sum(input_indices, input_values, input_shape, reduction_axes, keep_dims=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseReduceSum", name,
        tld.op_callbacks, input_indices, input_values, input_shape,
        reduction_axes, "keep_dims", keep_dims)
      return _result
    except _core._FallbackException:
...
def sparse_reduce_sum_sparse(input_indices, input_values, input_shape, reduction_axes, keep_dims=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseReduceSumSparse", name,
        tld.op_callbacks, input_indices, input_values, input_shape,
        reduction_axes, "keep_dims", keep_dims)
...
def sparse_reorder(input_indices, input_values, input_shape, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseReorder", name,
        tld.op_callbacks, input_indices, input_values, input_shape)
...
def sparse_reshape(input_indices, input_shape, new_shape, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseReshape", name,
        tld.op_callbacks, input_indices, input_shape, new_shape)
...
def sparse_slice(indices, values, shape, start, size, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseSlice", name,
        tld.op_callbacks, indices, values, shape, start, size)
...
def sparse_slice_grad(backprop_val_grad, input_indices, input_start, output_indices, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseSliceGrad", name,
        tld.op_callbacks, backprop_val_grad, input_indices, input_start,
        output_indices)
      return _result
    except _core._FallbackException:
      try:
...
def sparse_softmax(sp_indices, sp_values, sp_shape, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseSoftmax", name,
        tld.op_callbacks, sp_indices, sp_values, sp_shape)
      return _result
    except _core._FallbackException:
      try:
...
def sparse_softmax_eager_fallback(sp_indices, sp_values, sp_shape, name, ctx):
  _attr_T, (sp_values,) = _execute.args_to_matching_eager([sp_values], ctx)
  sp_indices = _ops.convert_to_tensor(sp_indices, _dtypes.int64)
  sp_shape = _ops.convert_to_tensor(sp_shape, _dtypes.int64)
...
def sparse_sparse_maximum(a_indices, a_values, a_shape, b_indices, b_values, b_shape, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseSparseMaximum", name,
        tld.op_callbacks, a_indices, a_values, a_shape, b_indices, b_values,
        b_shape)
...
def sparse_sparse_minimum(a_indices, a_values, a_shape, b_indices, b_values, b_shape, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseSparseMinimum", name,
        tld.op_callbacks, a_indices, a_values, a_shape, b_indices, b_values,
        b_shape)
...
def sparse_split(split_dim, indices, values, shape, num_split, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseSplit", name,
        tld.op_callbacks, split_dim, indices, values, shape, "num_split",
        num_split)
...
def sparse_tensor_dense_add(a_indices, a_values, a_shape, b, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseTensorDenseAdd", name,
        tld.op_callbacks, a_indices, a_values, a_shape, b)
      return _result
    except _core._FallbackException:
      try:
...
def sparse_tensor_dense_add_eager_fallback(a_indices, a_values, a_shape, b, name, ctx):
  ...
  _attr_Tindices, _inputs_Tindices = _execute.args_to_matching_eager([a_indices, a_shape], ctx)
...
def sparse_tensor_dense_mat_mul(a_indices, a_values, a_shape, b, adjoint_a=False, adjoint_b=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseTensorDenseMatMul",
        name, tld.op_callbacks, a_indices, a_values, a_shape, b, "adjoint_a",
...
def sparse_tensor_dense_mat_mul_eager_fallback(a_indices, a_values, a_shape, b, adjoint_a, adjoint_b, name, ctx):
  ...
  _attr_T, _inputs_T = _execute.args_to_matching_eager([a_values, b], ctx)
  (a_values, b) = _inputs_T
  _attr_Tindices, (a_indices,) = _execute.args_to_matching_eager([a_indices], ctx, _dtypes.int64)
  a_shape = _ops.convert_to_tensor(a_shape, _dtypes.int64)
  _inputs_flat = [a_indices, a_values, a_shape, b]
...
def sparse_to_dense(sparse_indices, output_shape, sparse_values, default_value, validate_indices=True, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SparseToDense", name,
        tld.op_callbacks, sparse_indices, output_shape, sparse_values,
        default_value, "validate_indices", validate_indices)
      return _result
    except _core._FallbackException:
      try:
...
def sparse_to_dense_eager_fallback(sparse_indices, output_shape, sparse_values, default_value, validate_indices, name, ctx):
  ...
  _attr_Tindices, _inputs_Tindices = _execute.args_to_matching_eager([sparse_indices, output_shape], ctx)
...
def take_many_sparse_from_tensors_map(sparse_handles, dtype, container="", shared_name="", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TakeManySparseFromTensorsMap",
        name, tld.op_callbacks, sparse_handles, "dtype", dtype, "container",
