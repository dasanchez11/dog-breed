...
def bitwise_or(x, y, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "BitwiseOr", name,
        tld.op_callbacks, x, y)
      return _result
    except _core._FallbackException:
      try:
...
def bitwise_xor(x, y, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "BitwiseXor", name,
        tld.op_callbacks, x, y)
      return _result
    except _core._FallbackException:
      try:
...
def left_shift(x, y, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "LeftShift", name,
        tld.op_callbacks, x, y)
      return _result
    except _core._FallbackException:
      try:
...
def population_count(x, name=None):
  ...
  **NOTE**: It is more efficient to first `tf.bitcast` your tensors into
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "PopulationCount", name,
        tld.op_callbacks, x)
      return _result
    except _core._FallbackException:
      try:
