  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "FixedLengthRecordReaderV2",
        name, tld.op_callbacks, "header_bytes", header_bytes, "record_bytes",
        record_bytes, "footer_bytes", footer_bytes, "hop_bytes", hop_bytes,
...
def identity_reader_v2(container="", shared_name="", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "IdentityReaderV2", name,
...
def matching_files(pattern, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MatchingFiles", name,
        tld.op_callbacks, pattern)
      return _result
    except _core._FallbackException:
      try:
...
def merge_v2_checkpoints(checkpoint_prefixes, destination_prefix, delete_old_dirs=True, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "MergeV2Checkpoints", name,
        tld.op_callbacks, checkpoint_prefixes, destination_prefix,
...
def read_file(filename, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ReadFile", name,
        tld.op_callbacks, filename)
      return _result
    except _core._FallbackException:
      try:
...
def reader_num_records_produced_v2(reader_handle, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ReaderNumRecordsProducedV2",
        name, tld.op_callbacks, reader_handle)
      return _result
    except _core._FallbackException:
      try:
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "ReaderNumWorkUnitsCompletedV2", name, tld.op_callbacks,
        reader_handle)
      return _result
    except _core._FallbackException:
      try:
...
def reader_read_up_to_v2(reader_handle, queue_handle, num_records, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ReaderReadUpToV2", name,
        tld.op_callbacks, reader_handle, queue_handle, num_records)
...
def reader_read_v2(reader_handle, queue_handle, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ReaderReadV2", name,
        tld.op_callbacks, reader_handle, queue_handle)
...
def reader_reset_v2(reader_handle, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ReaderResetV2", name,
        tld.op_callbacks, reader_handle)
      return _result
    except _core._FallbackException:
      try:
...
def reader_restore_state_v2(reader_handle, state, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ReaderRestoreStateV2", name,
        tld.op_callbacks, reader_handle, state)
      return _result
    except _core._FallbackException:
      try:
...
def reader_serialize_state_v2(reader_handle, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ReaderSerializeStateV2", name,
        tld.op_callbacks, reader_handle)
      return _result
    except _core._FallbackException:
      try:
...
def restore(file_pattern, tensor_name, dt, preferred_shard=-1, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Restore", name,
        tld.op_callbacks, file_pattern, tensor_name, "dt", dt,
...
def restore_slice(file_pattern, tensor_name, shape_and_slice, dt, preferred_shard=-1, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "RestoreSlice", name,
        tld.op_callbacks, file_pattern, tensor_name, shape_and_slice, "dt",
...
def restore_v2(prefix, tensor_names, shape_and_slices, dtypes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "RestoreV2", name,
        tld.op_callbacks, prefix, tensor_names, shape_and_slices, "dtypes",
        dtypes)
      return _result
    except _core._FallbackException:
      try:
...
def save(filename, tensor_names, data, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Save", name, tld.op_callbacks,
...
def save_slices(filename, tensor_names, shapes_and_slices, data, name=None):
  ...
  *  `start,length` where `start` and `length` are integers.  In that
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SaveSlices", name,
        tld.op_callbacks, filename, tensor_names, shapes_and_slices, data)
      return _result
    except _core._FallbackException:
      try:
...
def save_v2(prefix, tensor_names, shape_and_slices, tensors, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SaveV2", name,
...
def sharded_filename(basename, shard, num_shards, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ShardedFilename", name,
        tld.op_callbacks, basename, shard, num_shards)
      return _result
    except _core._FallbackException:
      try:
...
def sharded_filespec(basename, num_shards, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ShardedFilespec", name,
        tld.op_callbacks, basename, num_shards)
      return _result
    except _core._FallbackException:
      try:
...
def tf_record_reader_v2(container="", shared_name="", compression_type="", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TFRecordReaderV2", name,
        tld.op_callbacks, "container", container, "shared_name", shared_name,
...
def text_line_reader_v2(skip_header_lines=0, container="", shared_name="", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "TextLineReaderV2", name,
        tld.op_callbacks, "skip_header_lines", skip_header_lines, "container",
...
def whole_file_reader_v2(container="", shared_name="", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "WholeFileReaderV2", name,
        tld.op_callbacks, "container", container, "shared_name", shared_name)
      return _result
    except _core._FallbackException:
      try:
...
def write_file(filename, contents, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "WriteFile", name,
        tld.op_callbacks, filename, contents)
      return _result
    except _core._FallbackException:
      try:
