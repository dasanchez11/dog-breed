  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "AdjustContrast", name,
        tld.op_callbacks, images, contrast_factor, min_value, max_value)
      return _result
...
def adjust_contrastv2(images, contrast_factor, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "AdjustContrastv2", name,
        tld.op_callbacks, images, contrast_factor)
      return _result
    except _core._FallbackException:
      try:
...
def adjust_contrastv2_eager_fallback(images, contrast_factor, name, ctx):
  _attr_T, (images,) = _execute.args_to_matching_eager([images], ctx, _dtypes.float32)
  contrast_factor = _ops.convert_to_tensor(contrast_factor, _dtypes.float32)
...
def adjust_hue(images, delta, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "AdjustHue", name,
        tld.op_callbacks, images, delta)
      return _result
    except _core._FallbackException:
      try:
...
def adjust_saturation(images, scale, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "AdjustSaturation", name,
        tld.op_callbacks, images, scale)
      return _result
    except _core._FallbackException:
      try:
...
def combined_non_max_suppression(boxes, scores, max_output_size_per_class, max_total_size, iou_threshold, score_threshold, pad_per_class=False, clip_boxes=True, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "CombinedNonMaxSuppression",
        name, tld.op_callbacks, boxes, scores, max_output_size_per_class,
        max_total_size, iou_threshold, score_threshold, "pad_per_class",
        pad_per_class, "clip_boxes", clip_boxes)
...
def crop_and_resize(image, boxes, box_ind, crop_size, method="bilinear", extrapolation_value=0, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "CropAndResize", name,
        tld.op_callbacks, image, boxes, box_ind, crop_size, "method", method,
...
def crop_and_resize_eager_fallback(image, boxes, box_ind, crop_size, method, extrapolation_value, name, ctx):
  ...
  if extrapolation_value is None:
    extrapolation_value = 0
  extrapolation_value = _execute.make_float(extrapolation_value, "extrapolation_value")
  _attr_T, (image,) = _execute.args_to_matching_eager([image], ctx)
  boxes = _ops.convert_to_tensor(boxes, _dtypes.float32)
...
def crop_and_resize_grad_boxes(grads, image, boxes, box_ind, method="bilinear", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "CropAndResizeGradBoxes", name,
        tld.op_callbacks, grads, image, boxes, box_ind, "method", method)
      return _result
    except _core._FallbackException:
      try:
...
def crop_and_resize_grad_image(grads, boxes, box_ind, image_size, T, method="bilinear", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "CropAndResizeGradImage", name,
        tld.op_callbacks, grads, boxes, box_ind, image_size, "T", T, "method",
        method)
      return _result
    except _core._FallbackException:
      try:
...
def decode_and_crop_jpeg(contents, crop_window, channels=0, ratio=1, fancy_upscaling=True, try_recover_truncated=False, acceptable_fraction=1, dct_method="", name=None):
  ...
  *   3: output an RGB image.
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DecodeAndCropJpeg", name,
        tld.op_callbacks, contents, crop_window, "channels", channels,
...
def decode_bmp(contents, channels=0, name=None):
  ...
  *   4: output an RGBA image.
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DecodeBmp", name,
        tld.op_callbacks, contents, "channels", channels)
      return _result
    except _core._FallbackException:
      try:
...
def decode_gif(contents, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DecodeGif", name,
        tld.op_callbacks, contents)
      return _result
    except _core._FallbackException:
      try:
...
def decode_jpeg(contents, channels=0, ratio=1, fancy_upscaling=True, try_recover_truncated=False, acceptable_fraction=1, dct_method="", name=None):
  ...
  *   3: output an RGB image.
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DecodeJpeg", name,
        tld.op_callbacks, contents, "channels", channels, "ratio", ratio,
        "fancy_upscaling", fancy_upscaling, "try_recover_truncated",
...
def decode_png(contents, channels=0, dtype=_dtypes.uint8, name=None):
  ...
  *   4: output an RGBA image.
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DecodePng", name,
        tld.op_callbacks, contents, "channels", channels, "dtype", dtype)
      return _result
    except _core._FallbackException:
      try:
...
def draw_bounding_boxes(images, boxes, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DrawBoundingBoxes", name,
        tld.op_callbacks, images, boxes)
      return _result
    except _core._FallbackException:
      try:
...
def draw_bounding_boxes_v2(images, boxes, colors, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "DrawBoundingBoxesV2", name,
        tld.op_callbacks, images, boxes, colors)
      return _result
    except _core._FallbackException:
      try:
...
def encode_jpeg(image, format="", quality=95, progressive=False, optimize_size=False, chroma_downsampling=True, density_unit="in", x_density=300, y_density=300, xmp_metadata="", name=None):
  ...
  *   3: Output an RGB image.
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "EncodeJpeg", name,
        tld.op_callbacks, image, "format", format, "quality", quality,
...
def encode_jpeg_variable_quality(images, quality, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "EncodeJpegVariableQuality",
        name, tld.op_callbacks, images, quality)
      return _result
    except _core._FallbackException:
      try:
...
def encode_png(image, compression=-1, name=None):
  ...
  *   4: for RGBA.
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "EncodePng", name,
        tld.op_callbacks, image, "compression", compression)
      return _result
    except _core._FallbackException:
      try:
...
def encode_png_eager_fallback(image, compression, name, ctx):
  if compression is None:
    compression = -1
  compression = _execute.make_int(compression, "compression")
  _attr_T, (image,) = _execute.args_to_matching_eager([image], ctx, _dtypes.uint8)
  _inputs_flat = [image]
...
def extract_glimpse(input, size, offsets, centered=True, normalized=True, uniform_noise=True, noise="uniform", name=None):
  ...
  * If the coordinates are not normalized they are interpreted as
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ExtractGlimpse", name,
        tld.op_callbacks, input, size, offsets, "centered", centered,
        "normalized", normalized, "uniform_noise", uniform_noise, "noise",
        noise)
      return _result
    except _core._FallbackException:
      try:
...
def extract_jpeg_shape(contents, output_type=_dtypes.int32, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ExtractJpegShape", name,
        tld.op_callbacks, contents, "output_type", output_type)
      return _result
    except _core._FallbackException:
      try:
...
def generate_bounding_box_proposals(scores, bbox_deltas, image_info, anchors, nms_threshold, pre_nms_topn, min_size, post_nms_topn=300, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "GenerateBoundingBoxProposals",
        name, tld.op_callbacks, scores, bbox_deltas, image_info, anchors,
        nms_threshold, pre_nms_topn, min_size, "post_nms_topn", post_nms_topn)
...
def hsv_to_rgb(images, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "HSVToRGB", name,
        tld.op_callbacks, images)
      return _result
    except _core._FallbackException:
      try:
...
def non_max_suppression(boxes, scores, max_output_size, iou_threshold=0.5, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "NonMaxSuppression", name,
        tld.op_callbacks, boxes, scores, max_output_size, "iou_threshold",
        iou_threshold)
      return _result
    except _core._FallbackException:
      try:
...
def non_max_suppression_v2(boxes, scores, max_output_size, iou_threshold, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "NonMaxSuppressionV2", name,
        tld.op_callbacks, boxes, scores, max_output_size, iou_threshold)
      return _result
    except _core._FallbackException:
      try:
...
def non_max_suppression_v2_eager_fallback(boxes, scores, max_output_size, iou_threshold, name, ctx):
  _attr_T, _inputs_T = _execute.args_to_matching_eager([boxes, scores], ctx, _dtypes.float32)
  (boxes, scores) = _inputs_T
  _attr_T_threshold, (iou_threshold,) = _execute.args_to_matching_eager([iou_threshold], ctx, _dtypes.float32)
  max_output_size = _ops.convert_to_tensor(max_output_size, _dtypes.int32)
...
def non_max_suppression_v3(boxes, scores, max_output_size, iou_threshold, score_threshold, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "NonMaxSuppressionV3", name,
        tld.op_callbacks, boxes, scores, max_output_size, iou_threshold,
        score_threshold)
      return _result
    except _core._FallbackException:
...
def non_max_suppression_v3_eager_fallback(boxes, scores, max_output_size, iou_threshold, score_threshold, name, ctx):
  _attr_T, _inputs_T = _execute.args_to_matching_eager([boxes, scores], ctx, _dtypes.float32)
  (boxes, scores) = _inputs_T
  _attr_T_threshold, _inputs_T_threshold = _execute.args_to_matching_eager([iou_threshold, score_threshold], ctx, _dtypes.float32)
...
def non_max_suppression_v4(boxes, scores, max_output_size, iou_threshold, score_threshold, pad_to_max_output_size=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "NonMaxSuppressionV4", name,
        tld.op_callbacks, boxes, scores, max_output_size, iou_threshold,
        score_threshold, "pad_to_max_output_size", pad_to_max_output_size)
...
def non_max_suppression_v5(boxes, scores, max_output_size, iou_threshold, score_threshold, soft_nms_sigma, pad_to_max_output_size=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "NonMaxSuppressionV5", name,
        tld.op_callbacks, boxes, scores, max_output_size, iou_threshold,
...
def non_max_suppression_v5_eager_fallback(boxes, scores, max_output_size, iou_threshold, score_threshold, soft_nms_sigma, pad_to_max_output_size, name, ctx):
  if pad_to_max_output_size is None:
    pad_to_max_output_size = False
  pad_to_max_output_size = _execute.make_bool(pad_to_max_output_size, "pad_to_max_output_size")
  _attr_T, _inputs_T = _execute.args_to_matching_eager([boxes, scores, iou_threshold, score_threshold, soft_nms_sigma], ctx, _dtypes.float32)
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "NonMaxSuppressionWithOverlaps", name, tld.op_callbacks, overlaps,
        scores, max_output_size, overlap_threshold, score_threshold)
      return _result
    except _core._FallbackException:
      try:
...
def quantized_resize_bilinear(images, size, min, max, align_corners=False, half_pixel_centers=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "QuantizedResizeBilinear",
        name, tld.op_callbacks, images, size, min, max, "align_corners",
...
def rgb_to_hsv(images, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "RGBToHSV", name,
        tld.op_callbacks, images)
      return _result
    except _core._FallbackException:
      try:
...
def random_crop(image, size, seed=0, seed2=0, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "RandomCrop", name,
        tld.op_callbacks, image, size, "seed", seed, "seed2", seed2)
      return _result
    except _core._FallbackException:
      try:
...
def resize_area(images, size, align_corners=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ResizeArea", name,
        tld.op_callbacks, images, size, "align_corners", align_corners)
      return _result
    except _core._FallbackException:
      try:
...
def resize_bicubic(images, size, align_corners=False, half_pixel_centers=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ResizeBicubic", name,
        tld.op_callbacks, images, size, "align_corners", align_corners,
        "half_pixel_centers", half_pixel_centers)
      return _result
    except _core._FallbackException:
...
def resize_bicubic_grad(grads, original_image, align_corners=False, half_pixel_centers=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ResizeBicubicGrad", name,
        tld.op_callbacks, grads, original_image, "align_corners",
        align_corners, "half_pixel_centers", half_pixel_centers)
      return _result
    except _core._FallbackException:
      try:
...
def resize_bicubic_grad_eager_fallback(grads, original_image, align_corners, half_pixel_centers, name, ctx):
  ...
  if half_pixel_centers is None:
    half_pixel_centers = False
  half_pixel_centers = _execute.make_bool(half_pixel_centers, "half_pixel_centers")
  _attr_T, (original_image,) = _execute.args_to_matching_eager([original_image], ctx)
  grads = _ops.convert_to_tensor(grads, _dtypes.float32)
...
def resize_bilinear(images, size, align_corners=False, half_pixel_centers=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ResizeBilinear", name,
        tld.op_callbacks, images, size, "align_corners", align_corners,
        "half_pixel_centers", half_pixel_centers)
      return _result
    except _core._FallbackException:
...
def resize_bilinear_grad(grads, original_image, align_corners=False, half_pixel_centers=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ResizeBilinearGrad", name,
        tld.op_callbacks, grads, original_image, "align_corners",
        align_corners, "half_pixel_centers", half_pixel_centers)
      return _result
    except _core._FallbackException:
...
def resize_nearest_neighbor(images, size, align_corners=False, half_pixel_centers=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ResizeNearestNeighbor", name,
        tld.op_callbacks, images, size, "align_corners", align_corners,
        "half_pixel_centers", half_pixel_centers)
      return _result
    except _core._FallbackException:
...
def resize_nearest_neighbor_grad(grads, size, align_corners=False, half_pixel_centers=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ResizeNearestNeighborGrad",
        name, tld.op_callbacks, grads, size, "align_corners", align_corners,
        "half_pixel_centers", half_pixel_centers)
      return _result
    except _core._FallbackException:
      try:
...
def resize_nearest_neighbor_grad_eager_fallback(grads, size, align_corners, half_pixel_centers, name, ctx):
  ...
  if half_pixel_centers is None:
    half_pixel_centers = False
  half_pixel_centers = _execute.make_bool(half_pixel_centers, "half_pixel_centers")
  _attr_T, (grads,) = _execute.args_to_matching_eager([grads], ctx)
  size = _ops.convert_to_tensor(size, _dtypes.int32)
...
def sample_distorted_bounding_box(image_size, bounding_boxes, seed=0, seed2=0, min_object_covered=0.1, aspect_ratio_range=[0.75, 1.33], area_range=[0.05, 1], max_attempts=100, use_image_if_no_bounding_boxes=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SampleDistortedBoundingBox",
        name, tld.op_callbacks, image_size, bounding_boxes, "seed", seed,
...
def sample_distorted_bounding_box_eager_fallback(image_size, bounding_boxes, seed, seed2, min_object_covered, aspect_ratio_range, area_range, max_attempts, use_image_if_no_bounding_boxes, name, ctx):
  ...
  if use_image_if_no_bounding_boxes is None:
    use_image_if_no_bounding_boxes = False
  use_image_if_no_bounding_boxes = _execute.make_bool(use_image_if_no_bounding_boxes, "use_image_if_no_bounding_boxes")
  _attr_T, (image_size,) = _execute.args_to_matching_eager([image_size], ctx)
...
def sample_distorted_bounding_box_v2(image_size, bounding_boxes, min_object_covered, seed=0, seed2=0, aspect_ratio_range=[0.75, 1.33], area_range=[0.05, 1], max_attempts=100, use_image_if_no_bounding_boxes=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "SampleDistortedBoundingBoxV2",
        name, tld.op_callbacks, image_size, bounding_boxes,
...
def scale_and_translate(images, size, scale, translation, kernel_type="lanczos3", antialias=True, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ScaleAndTranslate", name,
        tld.op_callbacks, images, size, scale, translation, "kernel_type",
        kernel_type, "antialias", antialias)
      return _result
    except _core._FallbackException:
      try:
...
def scale_and_translate_grad(grads, original_image, scale, translation, kernel_type="lanczos3", antialias=True, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "ScaleAndTranslateGrad", name,
        tld.op_callbacks, grads, original_image, scale, translation,
...
def scale_and_translate_grad_eager_fallback(grads, original_image, scale, translation, kernel_type, antialias, name, ctx):
  ...
  if antialias is None:
    antialias = True
  antialias = _execute.make_bool(antialias, "antialias")
  _attr_T, _inputs_T = _execute.args_to_matching_eager([grads, original_image], ctx)
