  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "BoostedTreesAggregateStats",
        name, tld.op_callbacks, node_ids, gradients, hessians, feature,
...
def boosted_trees_bucketize(float_values, bucket_boundaries, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "BoostedTreesBucketize", name,
        tld.op_callbacks, float_values, bucket_boundaries)
      return _result
    except _core._FallbackException:
      try:
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "BoostedTreesCalculateBestFeatureSplit", name, tld.op_callbacks,
...
def boosted_trees_calculate_best_gains_per_feature(node_id_range, stats_summary_list, l1, l2, tree_complexity, min_node_weight, max_splits, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "BoostedTreesCalculateBestGainsPerFeature", name, tld.op_callbacks,
        node_id_range, stats_summary_list, l1, l2, tree_complexity,
        min_node_weight, "max_splits", max_splits)
...
def boosted_trees_center_bias(tree_ensemble_handle, mean_gradients, mean_hessians, l1, l2, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "BoostedTreesCenterBias", name,
        tld.op_callbacks, tree_ensemble_handle, mean_gradients, mean_hessians,
        l1, l2)
      return _result
    except _core._FallbackException:
      try:
...
def boosted_trees_create_ensemble(tree_ensemble_handle, stamp_token, tree_ensemble_serialized, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "BoostedTreesCreateEnsemble",
        name, tld.op_callbacks, tree_ensemble_handle, stamp_token,
...
def boosted_trees_create_quantile_stream_resource(quantile_stream_resource_handle, epsilon, num_streams, max_elements=1099511627776, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "BoostedTreesCreateQuantileStreamResource", name, tld.op_callbacks,
...
def boosted_trees_deserialize_ensemble(tree_ensemble_handle, stamp_token, tree_ensemble_serialized, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "BoostedTreesDeserializeEnsemble", name, tld.op_callbacks,
        tree_ensemble_handle, stamp_token, tree_ensemble_serialized)
      return _result
    except _core._FallbackException:
      try:
...
def boosted_trees_ensemble_resource_handle_op(container="", shared_name="", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "BoostedTreesEnsembleResourceHandleOp", name, tld.op_callbacks,
...
def boosted_trees_example_debug_outputs(tree_ensemble_handle, bucketized_features, logits_dimension, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "BoostedTreesExampleDebugOutputs", name, tld.op_callbacks,
...
def boosted_trees_flush_quantile_summaries(quantile_stream_resource_handle, num_features, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "BoostedTreesFlushQuantileSummaries", name, tld.op_callbacks,
...
def boosted_trees_get_ensemble_states(tree_ensemble_handle, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "BoostedTreesGetEnsembleStates", name, tld.op_callbacks,
...
def boosted_trees_make_quantile_summaries(float_values, example_weights, epsilon, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "BoostedTreesMakeQuantileSummaries", name, tld.op_callbacks,
        float_values, example_weights, epsilon)
      return _result
    except _core._FallbackException:
      try:
...
def boosted_trees_make_stats_summary(node_ids, gradients, hessians, bucketized_features_list, max_splits, num_buckets, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "BoostedTreesMakeStatsSummary",
        name, tld.op_callbacks, node_ids, gradients, hessians,
        bucketized_features_list, "max_splits", max_splits, "num_buckets",
        num_buckets)
      return _result
    except _core._FallbackException:
      try:
...
def boosted_trees_predict(tree_ensemble_handle, bucketized_features, logits_dimension, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "BoostedTreesPredict", name,
        tld.op_callbacks, tree_ensemble_handle, bucketized_features,
        "logits_dimension", logits_dimension)
      return _result
    except _core._FallbackException:
      try:
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        tld.op_callbacks, quantile_stream_resource_handle, summaries)
      return _result
    except _core._FallbackException:
      try:
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        tld.op_callbacks, quantile_stream_resource_handle, bucket_boundaries)
      return _result
    except _core._FallbackException:
      try:
...
def boosted_trees_quantile_stream_resource_flush(quantile_stream_resource_handle, num_buckets, generate_quantiles=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "BoostedTreesQuantileStreamResourceFlush", name, tld.op_callbacks,
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        tld.op_callbacks, quantile_stream_resource_handle, "num_features",
        num_features)
      return _result
    except _core._FallbackException:
      try:
...
def boosted_trees_quantile_stream_resource_handle_op(container="", shared_name="", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "BoostedTreesQuantileStreamResourceHandleOp", name, tld.op_callbacks,
        "container", container, "shared_name", shared_name)
      return _result
    except _core._FallbackException:
      try:
...
def boosted_trees_serialize_ensemble(tree_ensemble_handle, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "BoostedTreesSerializeEnsemble", name, tld.op_callbacks,
        tree_ensemble_handle)
...
def boosted_trees_sparse_aggregate_stats(node_ids, gradients, hessians, feature_indices, feature_values, feature_shape, max_splits, num_buckets, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "BoostedTreesSparseAggregateStats", name, tld.op_callbacks, node_ids,
        gradients, hessians, feature_indices, feature_values, feature_shape,
        "max_splits", max_splits, "num_buckets", num_buckets)
...
def boosted_trees_sparse_calculate_best_feature_split(node_id_range, stats_summary_indices, stats_summary_values, stats_summary_shape, l1, l2, tree_complexity, min_node_weight, logits_dimension, split_type="inequality", name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "BoostedTreesSparseCalculateBestFeatureSplit", name, tld.op_callbacks,
...
def boosted_trees_training_predict(tree_ensemble_handle, cached_tree_ids, cached_node_ids, bucketized_features, logits_dimension, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "BoostedTreesTrainingPredict",
        name, tld.op_callbacks, tree_ensemble_handle, cached_tree_ids,
        cached_node_ids, bucketized_features, "logits_dimension",
        logits_dimension)
...
def boosted_trees_update_ensemble(tree_ensemble_handle, feature_ids, node_ids, gains, thresholds, left_node_contribs, right_node_contribs, max_depth, learning_rate, pruning_mode, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "BoostedTreesUpdateEnsemble",
        name, tld.op_callbacks, tree_ensemble_handle, feature_ids, node_ids,
        gains, thresholds, left_node_contribs, right_node_contribs, max_depth,
        learning_rate, "pruning_mode", pruning_mode)
      return _result
    except _core._FallbackException:
      try:
...
def boosted_trees_update_ensemble_v2(tree_ensemble_handle, feature_ids, dimension_ids, node_ids, gains, thresholds, left_node_contribs, right_node_contribs, split_types, max_depth, learning_rate, pruning_mode, logits_dimension=1, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "BoostedTreesUpdateEnsembleV2",
        name, tld.op_callbacks, tree_ensemble_handle, feature_ids,
        dimension_ids, node_ids, gains, thresholds, left_node_contribs,
        right_node_contribs, split_types, max_depth, learning_rate,
        pruning_mode, "logits_dimension", logits_dimension)
      return _result
    except _core._FallbackException:
      try:
...
def is_boosted_trees_ensemble_initialized(tree_ensemble_handle, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name,
        "IsBoostedTreesEnsembleInitialized", name, tld.op_callbacks,
        tree_ensemble_handle)
      return _result
    except _core._FallbackException:
      try:
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        tld.op_callbacks, quantile_stream_resource_handle)
      return _result
    except _core._FallbackException:
      try:
