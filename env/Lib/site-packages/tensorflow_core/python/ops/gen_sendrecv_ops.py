  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Recv", name, tld.op_callbacks,
        "tensor_type", tensor_type, "tensor_name", tensor_name, "send_device",
...
def send(tensor, tensor_name, send_device, send_device_incarnation, recv_device, client_terminated=False, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "Send", name, tld.op_callbacks,
        tensor, "tensor_name", tensor_name, "send_device", send_device,
        "send_device_incarnation", send_device_incarnation, "recv_device",
        recv_device, "client_terminated", client_terminated)
      return _result
    except _core._FallbackException:
      try:
