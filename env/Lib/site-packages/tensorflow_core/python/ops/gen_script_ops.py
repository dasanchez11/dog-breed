  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        tld.op_callbacks, input, "token", token, "is_async", is_async, "Tout",
        Tout)
      return _result
...
def py_func(input, token, Tout, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "PyFunc", name,
        tld.op_callbacks, input, "token", token, "Tout", Tout)
      return _result
    except _core._FallbackException:
      try:
...
def py_func_stateless(input, token, Tout, name=None):
  ...
  if tld.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, tld.device_name, "PyFuncStateless", name,
        tld.op_callbacks, input, "token", token, "Tout", Tout)
      return _result
    except _core._FallbackException:
      try:
